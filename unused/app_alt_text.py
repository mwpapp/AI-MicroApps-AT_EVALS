APP_URL = "https://alt-text-describe.streamlit.app"
...
SYSTEM_PROMPT = "You accept app_images in url and file format to generate description or alt text according to W3C standards."
       ...
       "phase_instructions": "Generate the alt text for the image urls and uploads",
        "user_prompt": [
            ...
            },
            {
                ...
                "prompt": """I am sending you one or more complex app_images. Please provide a short description to identify the image, and a long description to represent the essential information conveyed by the image. \n
